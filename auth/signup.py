...
def sign_up_new_user(email: str, password: str, username: str, age: str, 
                     primary_health_care_provider_name: str, 
                     primary_health_care_contact_number: str, 
                     primary_health_care_contact_email: str):
